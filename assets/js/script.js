...
document.querySelector("#flip-penny").addEventListener('click', function(e){
    ...
    if (result <= 0.5) {
        ...
        document.querySelector("#status-message").textContent = "You got heads!"
    }       
            ...
            document.querySelector("#status-message").textContent = "You got tails!"
    ...
    //select the four counts/pcts and chnage the text
